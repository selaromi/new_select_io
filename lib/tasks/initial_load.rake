namespace :db do
  desc "Clean and fill database with countries"

  task initial_load: :environment do
    countries = [{name: "Afghanistan",            capital: "Kabul"},
                 ...
                 {name: "Burma/Myanmar",          capital: "Nay Pyi Taw"},
                 ...
                 {name: "Congo Democratic Republic of", capital: "Kinshasa"},
                 {name: "Costa Rica", capital:"San Jose"},
                 {name: "Cote d'Ivoire/Ivory Coast", capital: "Yamoussoukro"},
                 ...
                 {name: "Kiribati", capitl: "South Tarawa"},
    ...
    countries.each do |country|
      Country.create!(name:country[:name],capital:country[:capital])
    end
